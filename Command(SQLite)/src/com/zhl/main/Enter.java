...
public class Enter extends JFrame implements KeyListener, ActionListener {
	...
	public void keyPressed(KeyEvent e) {
		UserDao userDao = new UserDao();//一次创建，静态调用
	...
	public void actionPerformed(ActionEvent e) {
		if((userNameTextField.getText()!=null||!userNameTextField.equals(""))&&(passwordTextField.getText()!=null||!passwordTextField.getText().equals(""))) {
