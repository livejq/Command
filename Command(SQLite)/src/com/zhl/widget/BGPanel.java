	...
	protected void paintComponent(Graphics g) {
		...
		if (icon != null) {
			...
			case HORIZONGTAL_FILL:
				g.drawImage(icon.getImage(), 0, 0, getWidth(), icon.getIconHeight(), this);
				break;
			case VERTICAL_FILL:
				g.drawImage(icon.getImage(), 0, 0, icon.getIconWidth(), getHeight(), this);
				break;
			case BOTH_FILL:
