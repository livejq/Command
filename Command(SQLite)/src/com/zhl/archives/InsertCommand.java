		...
		insertButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if ((cmd.equals("")) || (function.equals("")) || (example.equals(""))) {
					JOptionPane.showMessageDialog(getContentPane(), "请将带星号的信息填写完整！", "温馨提示",
				...
				JOptionPane.showMessageDialog(getContentPane(), "数据添加成功！", "添加命令", JOptionPane.INFORMATION_MESSAGE);
